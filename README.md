...
## Knowledge-based Creative Director update

This build loads three Markdown rulebooks from `knowledge/` on every video generation request:

- `knowledge/furniture-video-rules.md`
- `knowledge/lighting-scene-rules.md`
- `knowledge/lighting-ad-system.md`

The backend combines Shopify product facts, selected Shopify materials, and these rulebooks into the OpenRouter video prompt. This is intended to reduce product hallucination, preserve product scale/details, and force videos into realistic full-scene ad contexts instead of plain backgrounds.
